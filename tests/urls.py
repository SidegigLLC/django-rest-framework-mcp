...
router.register(r"auth/unauthenticated", UnauthenticatedViewSet, basename="unauthenticated")
router.register(r"auth/customauth", CustomAuthViewSet, basename="customauth")
router.register(r"auth/custompermission", CustomPermissionViewSet, basename="custompermission")
